...
import { getDashboardStocksInFocus } from "@/lib/api/market-dashboard-api";
...
export function useDashboardStocksInFocus({
  ...
  return useQuery({
    queryKey: ["dashboard", "stocks-in-focus", exchange],
    queryFn: () => getDashboardStocksInFocus(exchange),
