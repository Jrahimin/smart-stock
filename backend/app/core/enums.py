...
class PortfolioWhatNextCode(StrEnum):
    DATA_INCOMPLETE = "DATA_INCOMPLETE"
    PRICE_STALE_OR_SUSPENDED = "PRICE_STALE_OR_SUSPENDED"
    REVIEW_SUPPORT_BREAK = "REVIEW_SUPPORT_BREAK"
    REVIEW_SELL_OR_REDUCE = "REVIEW_SELL_OR_REDUCE"
    REVIEW_ELEVATED_RISK = "REVIEW_ELEVATED_RISK"
    DO_NOT_AVERAGE_DOWN_FOR_COST_ONLY = "DO_NOT_AVERAGE_DOWN_FOR_COST_ONLY"
    WATCH_RESISTANCE = "WATCH_RESISTANCE"
    PROFITABLE_TREND_INTACT = "PROFITABLE_TREND_INTACT"
    NO_ACTION_NEEDED = "NO_ACTION_NEEDED"


class PortfolioAttentionCode(StrEnum):
    SUPPORT_BREAK = "SUPPORT_BREAK"
    SELL_OR_REDUCE = "SELL_OR_REDUCE"
    PRICE_QUALITY = "PRICE_QUALITY"
    ELEVATED_RISK = "ELEVATED_RISK"
    INCOMPLETE_HOLDING = "INCOMPLETE_HOLDING"
...
class PortfolioAttentionSeverity(StrEnum):
    HIGH = "HIGH"
    MEDIUM = "MEDIUM"
    LOW = "LOW"
    INFO = "INFO"
