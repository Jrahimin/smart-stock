...
from app.modules.admin_email_campaigns.admin_email_campaigns_router import (
    router as admin_email_campaigns_router,
)
...
from app.modules.portfolios.portfolios_router import router as portfolios_router
